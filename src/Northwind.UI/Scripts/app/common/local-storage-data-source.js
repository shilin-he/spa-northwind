define([], function () {
    ...
    return kendo.data.extensions.LocalStorageDataSource = kendo.data.DataSource.extend({
        init: function (options) {
            ...
            if (!(itemBase = options.itemBase)) {
                throw new Error('An itemBase string is required to uniquely identify the kind of entities in the localStorage.');
            }
